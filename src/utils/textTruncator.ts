...
import { QiitaArticle, QiitaComment } from '../types.js';
 ...
 */
export function combineArticleAndComments(
 ...
 */
export function formatSearchResults(articles: QiitaArticle[]): string {
